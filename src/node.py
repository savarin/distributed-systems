...
def initialize_socket(identifier: int) -> socket.socket:
    ...
    address = config.ADDRESS_BY_IDENTIFIER.get(identifier, ("localhost", 10000))
    sock.bind(address)
    sock.listen()
...
class Node:
    ...
    def __post_init__(self) -> None:
        ...
        self.outgoing: Dict[int, queue.Queue] = {
            i: queue.Queue() for i in config.ADDRESS_BY_IDENTIFIER
        }
    ...
    def deliver(self, identifier: int) -> None:
        ...
        """
        sock = None
        address = config.ADDRESS_BY_IDENTIFIER[identifier]
    ...
    def start(self) -> None:
        ...
        for i in config.ADDRESS_BY_IDENTIFIER:
